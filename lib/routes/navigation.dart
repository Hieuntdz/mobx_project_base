...
void pushAndReplace(BuildContext context, Widget widget, {bool isFullScreen = false}) {
  Navigator.of(context).pushReplacement(_createRoute(widget, isFullScreen: isFullScreen));
  if (pages.length > 0) {
...
Route _createRoute(Widget widget,
    {AnimationTransitionType animationTransitionType = AnimationTransitionType.slide_right,
